...
extension LoadingView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack {
            ...
            Text(__designTimeString("#15488.[1].[0].property.[0].[0].arg[0].value.[1].arg[0].value", fallback: "Loading...")) // Display a loading text
                .font(.headline)
        }
        .frame(maxWidth: .infinity, maxHeight: .infinity)
        .background(Color.white.opacity(__designTimeFloat("#15488.[1].[0].property.[0].[0].modifier[1].arg[0].value.modifier[0].arg[0].value", fallback: 0.8))) // Semi-transparent white background
