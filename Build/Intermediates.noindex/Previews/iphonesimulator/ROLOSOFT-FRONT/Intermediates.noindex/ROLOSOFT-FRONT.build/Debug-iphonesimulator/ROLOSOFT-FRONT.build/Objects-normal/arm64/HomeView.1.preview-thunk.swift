...
extension LogoutButton {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        Button(action: {
            ...
            Text(__designTimeString("#9333.[6].[2].property.[0].[0].arg[1].value.[0].arg[0].value", fallback: "Logout"))
                .foregroundColor(.red)
                .padding()
                .background(Color.gray.opacity(__designTimeFloat("#9333.[6].[2].property.[0].[0].arg[1].value.[0].modifier[2].arg[0].value.modifier[0].arg[0].value", fallback: 0.2)))
                .cornerRadius(__designTimeInteger("#9333.[6].[2].property.[0].[0].arg[1].value.[0].modifier[3].arg[0].value", fallback: 10))
        }
        .padding()
...
extension NavigationBarItemView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        HStack {
            NavigationLink(destination: Text(__designTimeString("#9333.[5].[0].property.[0].[0].arg[0].value.[0].arg[0].value.arg[0].value", fallback: "Profile"))) {
                Image(systemName: __designTimeString("#9333.[5].[0].property.[0].[0].arg[0].value.[0].arg[1].value.[0].arg[0].value", fallback: "person"))
            }
            .padding(.horizontal)
            
            NavigationLink(destination: Text(__designTimeString("#9333.[5].[0].property.[0].[0].arg[0].value.[1].arg[0].value.arg[0].value", fallback: "Settings"))) {
                Image(systemName: __designTimeString("#9333.[5].[0].property.[0].[0].arg[0].value.[1].arg[1].value.[0].arg[0].value", fallback: "gear"))
            }
            .padding(.horizontal)
        }
    ...
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack(alignment: .leading) {
            Text(title)
                .font(.title3)
                .padding()
                .background(Color.gray.opacity(__designTimeFloat("#9333.[4].[1].property.[0].[0].arg[1].value.[0].modifier[2].arg[0].value.modifier[0].arg[0].value", fallback: 0.2)))
                .cornerRadius(__designTimeInteger("#9333.[4].[1].property.[0].[0].arg[1].value.[0].modifier[3].arg[0].value", fallback: 10))
        }
        .padding(.vertical, __designTimeInteger("#9333.[4].[1].property.[0].[0].modifier[0].arg[1].value", fallback: 5))
...
extension BodyView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack(alignment: .leading) {
            List {
                ForEach(__designTimeInteger("#9333.[3].[0].property.[0].[0].arg[1].value.[0].arg[0].value.[0].arg[0].value.[0]", fallback: 1)..<__designTimeInteger("#9333.[3].[0].property.[0].[0].arg[1].value.[0].arg[0].value.[0].arg[0].value.[1]", fallback: 6)) { index in
...
extension HeaderView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack(alignment: .leading) {
            HStack {
                // Logo view
                Image(__designTimeString("#9333.[2].[0].property.[0].[0].arg[1].value.[0].arg[0].value.[0].arg[0].value", fallback: "frisa-logox4"))
                    .resizable()
                    .aspectRatio(contentMode: .fit)
                    .frame(height: __designTimeInteger("#9333.[2].[0].property.[0].[0].arg[1].value.[0].arg[0].value.[0].modifier[2].arg[0].value", fallback: 30))
                Spacer()
                // Notifications icon view
                Image(systemName: __designTimeString("#9333.[2].[0].property.[0].[0].arg[1].value.[0].arg[0].value.[2].arg[0].value", fallback: "bell"))
                    .font(.title)
