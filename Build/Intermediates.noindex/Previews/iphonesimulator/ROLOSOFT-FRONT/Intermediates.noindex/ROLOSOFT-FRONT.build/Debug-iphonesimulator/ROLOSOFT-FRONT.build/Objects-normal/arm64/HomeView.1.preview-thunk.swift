...
extension NavigationBarItemView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        HStack {
            ...
            NavigationLink(destination: Text(__designTimeString("#5728.[7].[0].property.[0].[0].arg[0].value.[1].arg[0].value.arg[0].value", fallback: "Settings"))) {
                Image(systemName: __designTimeString("#5728.[7].[0].property.[0].[0].arg[0].value.[1].arg[1].value.[0].arg[0].value", fallback: "gear"))
            }
            .padding(.horizontal)
        }
    ...
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack {
            if filteredEvents.isEmpty {
                List {
                    Text(__designTimeString("#5728.[5].[2].property.[0].[0].arg[0].value.[0].[0].[0].arg[0].value.[0].arg[0].value", fallback: "No hay partidos programados."))
                ...
                .listRowInsets(.init(
                    top: __designTimeInteger("#5728.[5].[2].property.[0].[0].arg[0].value.[0].[0].[0].modifier[1].arg[0].value.arg[0].value", fallback: 0),
                    leading: __designTimeInteger("#5728.[5].[2].property.[0].[0].arg[0].value.[0].[0].[0].modifier[1].arg[0].value.arg[1].value", fallback: 0),
                    bottom: __designTimeInteger("#5728.[5].[2].property.[0].[0].arg[0].value.[0].[0].[0].modifier[1].arg[0].value.arg[2].value", fallback: 8),
                    trailing: __designTimeInteger("#5728.[5].[2].property.[0].[0].arg[0].value.[0].[0].[0].modifier[1].arg[0].value.arg[3].value", fallback: 0))
                    )
            } else {
                List {
...
extension HeaderView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack(alignment: .center) {
            HStack {
                Image(__designTimeString("#5728.[4].[4].property.[0].[0].arg[1].value.[0].arg[0].value.[0].arg[0].value", fallback: "frisa-logox4"))
                    .resizable()
                    .aspectRatio(contentMode: .fit)
                    .frame(height: __designTimeInteger("#5728.[4].[4].property.[0].[0].arg[1].value.[0].arg[0].value.[0].modifier[2].arg[0].value", fallback: 30))
                Spacer()
                
                Image(systemName: __designTimeString("#5728.[4].[4].property.[0].[0].arg[1].value.[0].arg[0].value.[2].arg[0].value", fallback: "bell"))
                    .font(.title)
            ...
            DetailTeamCard(
                data: DetailTeamData(
                    name: __designTimeString("#5728.[4].[4].property.[0].[0].arg[1].value.[2].arg[0].value.arg[0].value", fallback: "Independiente Santa Fé"), // Replace with actual team name
                    logoImgUrl: __designTimeString("#5728.[4].[4].property.[0].[0].arg[1].value.[2].arg[0].value.arg[1].value", fallback: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Escudo_de_Independiente_Santa_Fe.png/150px-Escudo_de_Independiente_Santa_Fe.png"), // Replace with actual logo URL
                    victories: __designTimeInteger("#5728.[4].[4].property.[0].[0].arg[1].value.[2].arg[0].value.arg[2].value", fallback: 10), // Replace with actual data
                    ties: __designTimeInteger("#5728.[4].[4].property.[0].[0].arg[1].value.[2].arg[0].value.arg[3].value", fallback: 5), // Replace with actual data
                    defeats: __designTimeInteger("#5728.[4].[4].property.[0].[0].arg[1].value.[2].arg[0].value.arg[4].value", fallback: 3), // Replace with actual data
                    points: __designTimeInteger("#5728.[4].[4].property.[0].[0].arg[1].value.[2].arg[0].value.arg[5].value", fallback: 25) // Replace with actual data
                )
            )
            .padding(.horizontal)
        }
    ...
    @_dynamicReplacement(for: fetchMatchEvents()) private func __preview__fetchMatchEvents() {
        ...
        apiService.fetchMatchEvents(tournamentId: tournamentIdKey, token: jwt) { result in
            ...
            case .success(let events):
                print(__designTimeString("#5728.[3].[6].[2].modifier[0].arg[2].value.[0].[0].[0].arg[0].value", fallback: "SUCCESS"))
                DispatchQueue.main.async {
                    self.events = events
                }
            case .failure(let error):
                print(__designTimeString("#5728.[3].[6].[2].modifier[0].arg[2].value.[0].[1].[0].arg[0].value", fallback: "Failed to fetch match events:"), error.localizedDescription)
            }
        }
