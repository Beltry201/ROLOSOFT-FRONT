...
extension TeamTabBarButton {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        #sourceLocation(file: "/Users/David/Documents/Tec/Semestre 5/Ciberseguridad - swift/reto/ROLOSOFT-FRONT/ROLOSOFT-FRONT/Views/Team/TeamDetailView.swift", line: 104)
        VStack {
            Text(title)
        ...
        if let teamDetails = teamDetails {
            VStack {
                ...
                TabView(selection: $selectedTab) {
                    // Tab 1: Matches
                    VStack {
                        Text(__designTimeString("#10113.[1].[2].property.[0].[0].[0].[0].arg[0].value.[2].arg[1].value.[0].arg[0].value.[0].arg[0].value", fallback: "Matches content goes here"))
